...
def get_chatassistant_chain_GPT_FT():
    ...
    chain_GPT_FT = RePhraseQueryRetriever.fromllm(llm=llm_GPT_FT, retriever=vectorstore_GPT_FT.as_retriever(), memory=memory,combine_docs_chain_kwargs={"prompt": Prompt_GPT})
