...
Prompt_GPT = PromptTemplate(template=GPT_prompt_template, input_variables=["question", "context"])
...
def get_chatassistant_chain_GPT_FT():
    ...
    chain_GPT_FT = RePhraseQueryRetriever.from_llm(llm=llm_GPT_FT, retriever=vectorstore_GPT_FT.as_retriever(),prompt=Prompt_GPT)
