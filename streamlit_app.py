...
Prompt_GPT = PromptTemplate(template=GPT_prompt_template, input_variables=["question"])
...
def get_chatassistant_chain_GPT_FT():
    ...
    set_debug(True)
    llm_GPT_FT = ChatOpenAI(model="ft:gpt-3.5-turbo-0125:personal::9HSIhY3I", temperature=0)
    chain_GPT_FT = ConversationalRetrievalChain.fromllm(llm=llm_GPT_FT, retriever=vectorstore_GPT_FT.as_retriever(), memory=memory,combine_docs_chain_kwargs={"prompt": Prompt_GPT})
