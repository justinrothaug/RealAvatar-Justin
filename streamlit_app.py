        ...
        if mode == "Roleplay":
            ...
            with col1:
                with st.popover("Change Scenario", use_container_width=True):
                    ...
                    #else:
                    scenario = st.radio('Roleplay Mood or Location',('Friend','Happy','Sad', 'Interview', 'Podcast', 'Gym','Teammate', 'Cooking_Show', 'Zombie', 'Island', 'Memory', 'Murder_Mystery', 'Cyberpunk', 'Shakespeare', 'Rapper', 'Comedian', 'Custom_Time_Travel', 'Custom'), 
